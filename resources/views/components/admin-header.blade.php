<header  class="fixed top-0 left-0 right-0 bg-[E7E8E7] shadow-md py-4 px-6 relative z-50">
                ...
                <div id="dropdownAvatarName" class="z-50 hidden bg-gray-100 divide-y divide-[E7E8E7] rounded-lg shadow w-44 dark:divide-gray-600 absolute top-full mt-2 right-0">
                    ...
                    <div class="py-2">
                        <form method="POST" action="{{ route('logout') }} ">
                            @csrf
                            <button type="submit" class="w-full flex items-center px-4 py-2 text-sm hover:text-black hover:bg-red-300">
