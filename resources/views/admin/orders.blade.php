...
@section('admin-content')
            ...
            <x-admin-header/>
                ...
                <!-- Filters Section -->
                <div class="flex items-center bg-white px-8 py-4 rounded-md shadow-sm mb-6 w-[700px]">
                    <div class="flex items-center w-full">
                        <div class="border-2 border-solid border-gray-500 px-5 p-2">
                        ...
                        <div class="border-2 border-solid border-gray-500 px- p-2">
